...
user1.image.attach(io: file1, filename: "user1", content_type: "image/jpeg")
user1.save
...
user2.image.attach(io: file2, filename: "user2", content_type: "image/jpeg")
user2.save
...
user3.image.attach(io: file3, filename: "user3", content_type: "image/jpg")
user3.save
...
user4.image.attach(io: file4, filename: "user4", content_type: "image/jpeg")
user4.save
...
user5.image.attach(io: file5, filename: "user5", content_type: "image/jpg")
user5.save
...
user6.image.attach(io: file6, filename: "user6", content_type: "image/jpg")
user6.save
...
user7.image.attach(io: file7, filename: "user7", content_type: "image/jpg")
user7.save
...
user8.image.attach(io: file8, filename: "user8", content_type: "image/jpg")
user8.save
...
user9.image.attach(io: file9, filename: "user9", content_type: "image/jpeg")
user9.save
...
user10.image.attach(io: file10, filename: "user10", content_type: "image/jpg")
user10.save
